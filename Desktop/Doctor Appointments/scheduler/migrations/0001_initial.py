...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Availability',
            fields=[
                ('av_id', models.IntegerField(primary_key=True, serialize=False, unique=True)),
                ('date', models.DateTimeField()),
                ('start_time', models.DateTimeField(auto_now_add=True)),
                ('end_time', models.DateTimeField(auto_now_add=True)),
                ('day_of_week', models.CharField(choices=[('1', 'Monday'), ('2', 'Teusday'), ('3', 'Wednesday'), ('4', 'Thurday'), ('5', 'Friday')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.doctor', verbose_name='doctors')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.doctor', verbose_name='doctor')),
                ('patient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.patient', verbose_name='patients')),
            ],
            options={
