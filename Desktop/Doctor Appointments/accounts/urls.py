...
# Your existing router and urlpatterns code
from .views import AuthViewSet, PatientViewSet, AppointmentViewSet, DoctorViewSet, MedicalRecordsViewSet, ScheduleAppointmentView
from . import views
...
urlpatterns = [
    ...
    path("appointments/", AppointmentViewSet.as_view({"get": "get_appointments", "post": "create_appointment"}), name="appointment-list"),
